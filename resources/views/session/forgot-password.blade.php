...
<body>
  ...
  <div class="form-container-forgot">
    ...
    <div class="login-page">
                ...
                <form action="/forgot-verify" method="post" class="form-forgot">
                    @if ($errors->any())
                    ...
                    @endif
                    @csrf
                    <input type="text" name="email" placeholder="Input your email" class="mb-2" style="width:250px" />
                    <button class="mt-2 btn"  style="width:250px">SEND</button>
