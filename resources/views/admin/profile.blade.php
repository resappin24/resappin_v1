...
<div class="container-profile rounded bg-white mt-5 mb-5">
    <div class="row height">
        <div class="col-md-4 border-right height">
            <div class="d-flex flex-column align-items-center text-center p-3 py-3"><img class="rounded-circle mt-5" width="150px" src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg"><span class="font-weight-bold">ZENDY</span><span class="text-black-50">ZENDY@INSPIROTECHS.com</span><span> </span></div>
        </div>
